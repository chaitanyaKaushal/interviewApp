...
const NewInterviewScreen = (props) => {
  ...
  }, [dispatch, interviewId, formState])
      ...
      <ScrollView>
        <View style={styles.form}>
          ...
          <Input
            ...
            errorText='Please enter a valid starting month!'
            keyboardType='number-pad'
            returnKeyType='next'
            onInputChange={inputChangeHandler}
          ...
          <Input
            id='startHour'
            label='Starting Hour (24-hr format)'
          ...
          <Input
            id='endDate'
            label='Ending Date'
            errorText='Please enter a valid ending date!'
            keyboardType='number-pad'
            autoCorrect
            returnKeyType='next'
            onInputChange={inputChangeHandler}
          ...
          <Input
            id='endMonth'
            label='Ending Month'
            errorText='Please enter a valid ending month'
            keyboardType='number-pad'
            returnKeyType='next'
            onInputChange={inputChangeHandler}
          ...
          <Input
            id='endHour'
            label='Ending Hour(24-hr format)'
